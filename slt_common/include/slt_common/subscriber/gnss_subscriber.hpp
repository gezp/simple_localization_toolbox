...
#include "slt_interface/msg/gnss_data.hpp"
...
private:
  void msg_callback(slt_interface::msg::GnssData::SharedPtr msg);

private:
  rclcpp::Node::SharedPtr node_;
  rclcpp::Subscription<slt_interface::msg::GnssData>::SharedPtr subscriber_;
